...
router.get('/soyPremium', auth.isAuthUser ,usuario.getSoyPremium)
router.get('/username/:username',usuario.getUsuarioUsername)
...
router.post('/validate',auth.isAuthUser,usuario.validateCorreo)
