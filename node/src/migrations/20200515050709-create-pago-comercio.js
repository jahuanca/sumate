...
module.exports = {
  up: (queryInterface, Sequelize) => {
    return queryInterface.createTable('Pago_Comercio', {
      id: {
        allowNull: false,
        autoIncrement: true,
        primaryKey: true,
      ...
      imagen: {type: Sequelize.STRING(200), allowNull: true, validate: {notEmpty: true, len: [1,200]}},
  ...
  down: (queryInterface, Sequelize) => {
    return queryInterface.dropTable('Pago_Comercio');
  }
};